...
REQUIRED_ENV_KEYS=(CONVEX_URL OPENAI_API_KEY GEMINI_API_KEY GEMINI_EMBEDDING_MODEL EMBEDDING_PROVIDER OBSIDIAN_VAULT_PATH CRYSTAL_MCP_MODE CRYSTAL_MCP_HOST CRYSTAL_MCP_PORT)
