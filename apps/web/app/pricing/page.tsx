...
const pricingPlans = [
  ...
  },
  {
    ...
    price: "$20/mo",
    button: "START PRO",
    checkoutHref: "https://polar.sh/illumin8ca/products/f78ee82b-719e-4de8-850a-3e9eea3db4b0",
    badge: "MOST POPULAR",
  ...
  },
  {
    ...
    price: "$100/mo",
    button: "START ULTRA",
    checkoutHref: "https://polar.sh/illumin8ca/products/9d59dd76-5026-4079-95f7-bf594f71121b",
