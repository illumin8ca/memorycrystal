...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-void flex flex-col">
      ...
      <div className="w-full max-w-sm border border-border bg-surface p-6 sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-accent hover:bg-accent-dim text-white p-3 min-h-11 font-semibold text-sm transition-colors disabled:opacity-60"
            style={{ borderRadius: 0 }}
          >
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-elevated border border-border text-primary p-3 min-h-11 text-sm hover:border-accent transition-colors disabled:opacity-60"
            style={{ borderRadius: 0 }}
          >
