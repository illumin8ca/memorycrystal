...
const releaseEntries = [
  {
    ...
    date: "March 14, 2026",
    items: [
      "Fixed recall/search tools returning zero results — channel hard-filter removed from memory_search, crystal_recall, crystal_what_do_i_know, and crystal_why_did_we",
